                    ...
                    <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sa" title="Arabic">
                                <img src="{{ asset('assets/images/flags/sa.svg') }}" alt="user-image" class="me-2 rounded-circle" height="18">
            ...
            <ul class="navbar-nav mx-lg-auto mb-2 mb-lg-0" id="navigation-menu">
                <li class="nav-item d-block d-lg-none">
                    <a class="d-block p-3 h-auto text-center" href="index.html">
                        <img src="{{ asset('assets/images/logo-dark.png') }}" alt="" height="25" class="card-logo-dark mx-auto">
                        <img src="{{ asset('assets/images/logo-light.png') }}" alt="" height="25" class="card-logo-light mx-auto">
                    </a>
                </li>
                                    ...
                                    <div class="row g-2">
                                        <div class="col-lg-4">
                                            <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ asset('assets/images/brands/img-8.png') }}" alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ asset('assets/images/brands/img-2.png') }}" alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ asset('assets/images/brands/img-3.png') }}" alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ asset('assets/images/brands/img-4.png') }}" alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ asset('assets/images/brands/img-5.png') }}" alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                        <div class="col-lg-4">
                                            <a href="#!" class="d-block p-2 border border-dashed text-center rounded-3">
                                                <img src="{{ asset('assets/images/brands/img-6.png') }}" alt="" class="avatar-sm">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-5 d-none d-lg-block">
                                <div class="card rounded-start rounded-0 border-0 h-100 mb-0 overflow-hidden" style="background-image: url('../assets/images/ecommerce/img-2.jpg'); background-size: cover;">
                                    ...
                                    <div class="card-body d-flex align-items-center justify-content-center position-relative">
                                        <div class="text-center">
                                            <h6 class="card-title text-white">Welcome to Monkey Beanies</h6>
