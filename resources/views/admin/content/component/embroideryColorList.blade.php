...
@section('content')
<h4 class="py-3 mb-4">
    <span class="text-muted fw-light">Component /</span> Embroidery Color List
</h4>
            ...
            <tbody>
                @foreach ($colors as $color)
                    <tr>
                        ...
                        <td>
                            <!-- Edit Button -->
                            <a href="{{ route('content-embroidery-color-edit', $color->id) }}" class="me-2">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                        
                            <!-- Delete Button -->
                            <form action="{{ route('content-embroidery-color-delete', $color->id) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
